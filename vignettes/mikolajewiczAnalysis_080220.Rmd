...
# df.qc1 <- filterFeatures(df.qc1, "scanner", "XCT1")
# df.efp <- filterFeatures(df.efp, "scanner", "XCT1")
# df.invivo <- filterFeatures(df.invivo, "scanner", "XCT1")
...
analyze.these <- analyzeWhich(co, include.parameters = c("Tt.vBMD"), omit.sites = c("Odense","Aarhus","Cambridge"))
