...
# show rms statistics
showTable(calibration.results.qc1[["calibration.equations"]])

showTable(calibration.results.efp[["calibration.equations"]])
```
...
diagnosticPlot(co, which.assay = "EFP", which.parameter = "Tt.vBMD", which.plot = "residual", fix.axis = T)
```
