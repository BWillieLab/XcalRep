...
# df.invivo <- invivo_unregistered
df.invivo <- invivo_registered
...
```{r}
# - c('Tt.vBMD', 'Ct.vBMD.XCT2', 'Tb.vBMD', 'Ct.Ar.XCT2', 'Ct.Th.XCT2', 'Ct.Po','Tb.BVTV', 
...
analyze.these <- analyzeWhich(co,
                              include.parameters =  c("Tt.vBMD", "Tb.vBMD", "Ct.vBMD.XCT2",
                                                     "Ct.Th.XCT2", "Ct.Po", "Tt.Ar", "Tb.Ar", "Ct.Ar.XCT2", "Ct.Pm"))
...
# analyze.these <- analyzeWhich(co,
#                               omit.sites = c("Odense","Vanderbilt","Aarhus","Paris","Toronto","Cambridge","WUSTL","Southamptom","Montreal","Baylor", "Lyon", "JohnHopkins"),
#                               include.parameters = "Tt.vBMD")

# omit.sites = c("Odense","Aarhus","Cambridge")
# # omit.sites = c("Odense","Aarhus","Cambridge")
# analyze.these <- analyzeWhich(co, 
#                              include.parameters =  c("Tt.vBMD", "Tb.vBMD", "Ct.vBMD.XCT2", "Ct.Th.XCT2", "Ct.Ar.XCT2", "Tb.Ar", "Tb.N", "Tb.Th", "Tb.Sp", "peripheral.medullary.Tb.BD","inhomogeneity.Tb.network", "app.modulus","stiffness","failure.load"))

                              # include.parameters = c("Tt.vBMD", "Tb.vBMD", "Ct.vBMD.XCT2",
                              #                        "Ct.Th.XCT2", "Tt.Ar", "Tb.Ar", "Ct.Ar.XCT2", "Ct.Pm"),
...
# omit.sites = c("Odense","Aarhus","Cambridge", "Southamptom","Toronto","Paris","Montreal","WUSTL","Lyon","Baylor", "Vanderbilt")
# include.parameters = c("Tt.vBMD", "Tb.vBMD", "Ct.vBMD.XCT2", "Ct.Th.XCT2", "Tt.Ar", "Tb.Ar", "Ct.Ar.XCT2", "Ct.Pm")
str(analyze.these)
```
...
#         group.by = c("phantom"),
#         which.phantom = c("radius", "tibia"),
#          which.parameter = c("Tt.vBMD", "Tb.vBMD", "Ct.vBMD.XCT2", "Ct.Th.XCT2", "Ct.Ar.XCT2", "Tb.Ar", "Tb.N", "Tb.Th", "Tb.Sp", "peripheral.medullary.Tb.BD","inhomogeneity.Tb.network", "app.modulus","stiffness","failure.load"),
#         var2plot = "cv",
#         outliers = F,
#         color.begin = 0.5,
#         color.end = 1,
...
# svpPlot(co,
#         which.data = "uncalibrated",
#         group.by = c("scanner", "phantom"),
#         which.phantom = c("QC1", "EFP", "radius", "tibia"),
...
co <- fitCalibration(co, 
                     ...
                     x.fold.val = F, which.center = "mean")
...
# diagnosticPlot(co, which.assay = "EFP", which.plot = "line")
```
...
# 
# diagnosticPlot(co, which.assay = "EFP", which.parameter = "Tt.vBMD",which.plot = "dif", fix.axis = T)
# \
...
showTable(mvp.results.efp[["rms.statistics"]])
```
